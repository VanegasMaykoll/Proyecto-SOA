#!/usr/bin/env bash
# ==============================================================================
# PRUEBA 01: NEGATIVE LOOKUPS (readmissing)
# Evalúa el escenario de mayor exigencia para los filtros probabilísticos:
# 100% de consultas a claves inexistentes que deben ser filtradas en RAM.
# ==============================================================================
...
TEST_ID="01"
TEST_NAME="Negative Lookups (readmissing)"
TEST_DESC="Lectura de claves inexistentes (100% misses). Evalúa el ahorro de I/O a disco."
TARGET_OP="readmissing"

echo "================================================================================"
echo " EJECUTANDO PRUEBA ${TEST_ID}: ${TEST_NAME}"
echo " Operaciones: N=${NUM_KEYS} writes, Reads=${NUM_READS} missing reads"
echo "================================================================================"
...
for engine in "${ENGINES[@]}"; do
    ...
    for variant in "${VARIANTS[@]}"; do
        ...
        LOG_FILE="${RAW_LOGS_DIR}/${engine}/${TEST_ID}_readmissing_${variant}.log"
        ...
        "${BIN}" \
            --db="${DB_DIR}" \
            --benchmarks="fillrandom,readmissing" \
            --num="${NUM_KEYS}" \
            --reads="${NUM_READS}" \
