...
#ifndef STORAGE_LEVELDB_UTIL_XOR_FILTER_H_
#define STORAGE_LEVELDB_UTIL_XOR_FILTER_H_
...
//
// The filter is static: LevelDB constructs it from the complete key set
...
#endif  // STORAGE_LEVELDB_UTIL_XOR_FILTER_H_
